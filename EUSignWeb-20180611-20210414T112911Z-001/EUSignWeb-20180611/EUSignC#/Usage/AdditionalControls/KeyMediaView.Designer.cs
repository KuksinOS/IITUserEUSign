namespace EUSignTestCS.AdditionalControls
{
	partial class KeyMediaView
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelKMName.Location = new System.Drawing.Point(402, 77);
			this.labelKMName.Name = "labelKMName";
			this.labelKMName.Size = new System.Drawing.Size(129, 42);
			this.labelKMName.TabIndex = 16;
			// 
			// labelKMType
			// 
			...
			this.labelKMType.Location = new System.Drawing.Point(402, 26);
			this.labelKMType.Name = "labelKMType";
			this.labelKMType.Size = new System.Drawing.Size(129, 42);
			this.labelKMType.TabIndex = 14;
			// 
			// labelKMNameText
			// 
			...
			this.treeViewKMs.Location = new System.Drawing.Point(3, 3);
			this.treeViewKMs.Name = "treeViewKMs";
			this.treeViewKMs.Size = new System.Drawing.Size(348, 210);
			this.treeViewKMs.TabIndex = 12;
			...
			this.panelPassword.Location = new System.Drawing.Point(3, 219);
			...
			this.pictureBoxSplitImageTop.Location = new System.Drawing.Point(361, 17);
			...
			this.pictureBoxSplitImageTop.TabIndex = 15;
			...
			this.checkBoxFormat.TabIndex = 9;
			...
			this.labelConfirmPassword.Location = new System.Drawing.Point(7, 32);
			...
			this.labelNewPassword.Location = new System.Drawing.Point(7, 6);
			...
			this.linkLabelKMsUpdate.Location = new System.Drawing.Point(357, 181);
			...
			this.Controls.Add(this.linkLabelKMsUpdate);
			this.Controls.Add(this.labelKMName);
			this.Controls.Add(this.labelKMType);
			this.Controls.Add(this.labelKMNameText);
			this.Controls.Add(this.labelKMTypeText);
			this.Controls.Add(this.pictureBoxSplitImageTop);
			this.Controls.Add(this.labelKMInfo);
			this.Controls.Add(this.treeViewKMs);
