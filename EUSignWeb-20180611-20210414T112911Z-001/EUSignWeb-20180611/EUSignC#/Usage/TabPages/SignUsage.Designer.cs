namespace EUSignTestCS.TabPages
{
	partial class SignUsage
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkBoxAddCACerts = new System.Windows.Forms.CheckBox();
			...
			this.checkBoxAppendCerificate = new System.Windows.Forms.CheckBox();
			this.checkBoxHashSign = new System.Windows.Forms.CheckBox();
			this.checkBoxRawSign = new System.Windows.Forms.CheckBox();
			this.checkBoxInternalSign = new System.Windows.Forms.CheckBox();
			...
			// panelParams
			// 
			this.panelParams.Controls.Add(this.checkBoxAddCACerts);
			...
			this.panelParams.Controls.Add(this.checkBoxAppendCerificate);
			this.panelParams.Controls.Add(this.checkBoxHashSign);
			this.panelParams.Controls.Add(this.checkBoxRawSign);
			this.panelParams.Controls.Add(this.checkBoxInternalSign);
			...
			this.panelParams.Size = new System.Drawing.Size(520, 150);
			this.panelParams.TabIndex = 6;
			// 
			// checkBoxAddCACerts
			// 
			this.checkBoxAddCACerts.AutoSize = true;
			this.checkBoxAddCACerts.Checked = true;
			this.checkBoxAddCACerts.CheckState = System.Windows.Forms.CheckState.Checked;
			this.checkBoxAddCACerts.Location = new System.Drawing.Point(235, 127);
			this.checkBoxAddCACerts.Name = "checkBoxAddCACerts";
			this.checkBoxAddCACerts.Size = new System.Drawing.Size(202, 17);
			this.checkBoxAddCACerts.TabIndex = 28;
			this.checkBoxAddCACerts.Text = "Додавати повні дані для перевірки";
			this.checkBoxAddCACerts.UseVisualStyleBackColor = true;
			this.checkBoxAddCACerts.CheckedChanged += new System.EventHandler(this.checkBoxAddCACerts_CheckedChanged);
			// 
			...
			this.checkBoxAddContentTimeStamp.Location = new System.Drawing.Point(25, 127);
			...
			this.comboBoxSignType.Items.AddRange(new object[] {
            "базовий",
            "з позначкою часу від ЕЦП",
            "з посиланням на повні дані для перевірки",
            "з повними даними для перевірки"});
			this.comboBoxSignType.Location = new System.Drawing.Point(132, 100);
			this.comboBoxSignType.Name = "comboBoxSignType";
			this.comboBoxSignType.Size = new System.Drawing.Size(226, 21);
			this.comboBoxSignType.TabIndex = 26;
			this.comboBoxSignType.SelectedIndexChanged += new System.EventHandler(this.comboBoxSignType_SelectedIndexChanged);
			// 
			// labelSignTypeTitle
			// 
			this.labelSignTypeTitle.Location = new System.Drawing.Point(26, 103);
			this.labelSignTypeTitle.Margin = new System.Windows.Forms.Padding(0);
			this.labelSignTypeTitle.Name = "labelSignTypeTitle";
			this.labelSignTypeTitle.Size = new System.Drawing.Size(103, 13);
			this.labelSignTypeTitle.TabIndex = 25;
			this.labelSignTypeTitle.Text = "Формат підпису:";
			// 
			// checkBoxHashParamsFromCert
			// 
			this.checkBoxHashParamsFromCert.AutoSize = true;
			this.checkBoxHashParamsFromCert.Location = new System.Drawing.Point(235, 77);
			...
			// 
			// checkBoxAppendCerificate
			// 
			this.checkBoxAppendCerificate.AutoSize = true;
			this.checkBoxAppendCerificate.Location = new System.Drawing.Point(235, 31);
			this.checkBoxAppendCerificate.Name = "checkBoxAppendCerificate";
			this.checkBoxAppendCerificate.Size = new System.Drawing.Size(123, 17);
			this.checkBoxAppendCerificate.TabIndex = 9;
			this.checkBoxAppendCerificate.Text = "Додати сертифікат";
			this.checkBoxAppendCerificate.UseVisualStyleBackColor = true;
			// 
			// checkBoxHashSign
			// 
			this.checkBoxHashSign.AutoSize = true;
			this.checkBoxHashSign.Location = new System.Drawing.Point(25, 77);
			this.checkBoxHashSign.Name = "checkBoxHashSign";
			this.checkBoxHashSign.Size = new System.Drawing.Size(110, 17);
			this.checkBoxHashSign.TabIndex = 8;
			this.checkBoxHashSign.Text = "Підписувати геш";
			...
			// checkBoxRawSign
			// 
			this.checkBoxRawSign.AutoSize = true;
			this.checkBoxRawSign.Location = new System.Drawing.Point(25, 54);
			this.checkBoxRawSign.Name = "checkBoxRawSign";
			this.checkBoxRawSign.Size = new System.Drawing.Size(211, 17);
			this.checkBoxRawSign.TabIndex = 7;
			this.checkBoxRawSign.Text = "Використовувати скорочений підпис";
			this.checkBoxRawSign.UseVisualStyleBackColor = true;
			this.checkBoxRawSign.CheckedChanged += new System.EventHandler(this.checkBoxRawSign_CheckedChanged);
			// 
			// checkBoxInternalSign
			// 
			this.checkBoxInternalSign.AutoSize = true;
			this.checkBoxInternalSign.Location = new System.Drawing.Point(25, 31);
			this.checkBoxInternalSign.Name = "checkBoxInternalSign";
			this.checkBoxInternalSign.Size = new System.Drawing.Size(204, 17);
			this.checkBoxInternalSign.TabIndex = 6;
			this.checkBoxInternalSign.Text = "Використовувати внутрішній підпис";
			this.checkBoxInternalSign.UseVisualStyleBackColor = true;
			this.checkBoxInternalSign.CheckedChanged += new System.EventHandler(this.checkBoxInternalSign_CheckedChanged);
			// 
			// labelParamsTitle
			// 
			...
			this.pictureBoxSplitParams.Location = new System.Drawing.Point(0, 149);
			...
			this.panelSignData.Location = new System.Drawing.Point(0, 150);
			...
			this.panelSignFile.Location = new System.Drawing.Point(0, 340);
			...
			this.panelTest.Location = new System.Drawing.Point(0, 574);
		...
		private System.Windows.Forms.CheckBox checkBoxAppendCerificate;
		private System.Windows.Forms.CheckBox checkBoxHashSign;
		private System.Windows.Forms.CheckBox checkBoxRawSign;
		private System.Windows.Forms.CheckBox checkBoxInternalSign;
		...
		private System.Windows.Forms.CheckBox checkBoxAddCACerts;
